...
def experiment_qrs_no_amp_one_matching_element():

    filename = "experiments_qrs_no_amp_one_match.csv"
...
def experiment_qrs_no_amp_no_matching_element():

    filename = "experiment_qrs_no_amp_no_matching_element.csv"
    writer = get_writer(filename)
...
def experiment_qrs_no_amp_subset_grover():

    filename = "experiment_qrs_no_amp_subset_grover.csv"
    writer = get_writer(filename)
...
def experiment_qrs_no_amp_one_match_duplicates():
    filename = "experiment_qrs_no_amp_one_match_duplicates.csv"
    writer = get_writer(filename)
